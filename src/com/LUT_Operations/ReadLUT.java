...
public class ReadLUT {
    ...
    private void Read_CAL_ID(JTextField Cal_ID) {
        String calIdfromECU = "";
        int[] read_call_array
                = {Serial_Read_array[923], //P
                    Serial_Read_array[924], //4
                    Serial_Read_array[925], //0
                    Serial_Read_array[926], //1
                    Serial_Read_array[927], //R
                    Serial_Read_array[928], //E
                    Serial_Read_array[929], //P
                    Serial_Read_array[930], //A
                    Serial_Read_array[931], //D
                    Serial_Read_array[932], //I
                    Serial_Read_array[933], //1
                    Serial_Read_array[934], //0
                    Serial_Read_array[935], //0
                    Serial_Read_array[936], //1
                    Serial_Read_array[937], //2
                    Serial_Read_array[938] //3
            };
    ...
    private void read_CVN(JTextField CVN, JTextArea lutName) {
        ...
        String strCVN = "";
        CVN_array[1] = String.valueOf(Serial_Read_array[1119]);
        CVN_array[2] = String.valueOf(Serial_Read_array[1120]);
        CVN_array[3] = String.valueOf(Serial_Read_array[1121]);
        CVN_array[4] = String.valueOf(Serial_Read_array[1122]);
...
//        System.out.println("Reading CVN.....");
    ...
    public void Read_ECU(
            SerialPort portVar, JTable tableDOI, JTable tableSOI, JTextField Cal_ID, JTextField VIN, JTable tableEGR, JTextField CVN, JTextField Engine_Speed, JTextField Fuel_Cut_OFF, JTextField DOI_miocrosec, JTextField DOI_OP, JTextField Sec_EOT, JTextField Sec_EOT_CF, JTextField pumpON, JTextField glowPlug, JTextField VSS_CF, JTextField Max_Accleration, JTextField EGR_ADC_Max, JTextField EGR_ADC_Min, JTextField Consumption_Error_max, JTextField Consumption_Error_min, JTextField WI_Reset, JTextField min_Consumption, JTextField inducement, JTable Temperature, JTable Pressure, JTextArea lutName, JCheckBox onlineData, SerialPort port, JButton ReadBtn, JButton UpdateBtn, JButton flashBtn, JTable table_OD, JTable table_ADC, JTable errorCodeDTC, JTable freezeFrame, JTable descriptionDTC, JProgressBar statusMIL, JProgressBar statusPump, JProgressBar statusEngineHalt, JTable consumptionData, JLabel lblDTCCount, JProgressBar waterLevel, JLabel waterLevelPercent, JLabel display_message, JTable tableEGT, JTable tableDeltaPressure, JTable newFreezeFrame, JLabel display_msg_1, JRadioButtonMenuItem btn100, JRadioButtonMenuItem btn500, JRadioButtonMenuItem btn1000, JTable table_DOI, JLabel comStatus, JButton btnConnect, JButton btnDisconnect, JScrollPane jScrollPane5, JTextField txtParam3, JTextField txtParam4, JTextField txtParam5, JTextField txtParam6, JTextField txtParam7, JLabel lblDatafrequency, JCheckBoxMenuItem ConvertADC, JProgressBar statusWIM, JProgressBar statusWaterEmpty, JProgressBar statusInducement, JLabel lbl_FWversion, JLabel comProtocol, JLabel Function) {
